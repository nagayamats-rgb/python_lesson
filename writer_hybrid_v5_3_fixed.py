# -*- coding: utf-8 -*-
"""
KOTOHA ENGINE — Hybrid AI Writer v5.3 (最終安定版)
GPT-5対応: max_tokens → max_completion_tokens
"""
...
{{
  ...
  "alt": "ここに生成結果"
    ...
    res = client.chat.completions.create(
        ...
        temperature=0.7,
        max_completion_tokens=500  # ← GPT-5対応（変更点）
    )
...
# =========================================================
def main():
    print("🌸 Hybrid AI Writer v5.3 実行開始（全件AI生成・全構造対応）")
